...
export default function Scene({ ...props }) {
  const { nodes, materials } = useSpline('https://prod.spline.design/LIr0k9q3NLRBzLx3/scene.splinecode')
  return (
    <>
      <color attach="background" args={['rgb(4, 4, 29)']} />
